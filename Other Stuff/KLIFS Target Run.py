...
for i in range(2, sh.max_row+1):
    try:
        ...
        name = kinase_group + '_' + kinase_family + '_' + kinase_name + '_' + ligand_name + '_' + ligand_expo_id \
               + '.xlsx'
        out = Workbook(name)
        out.save('C:\\Users\\fox8fv\\PycharmProjects\\Opencadd_real\\KLIFS Targets Output\\' + name)
        out = openpyxl.load_workbook('C:\\Users\\fox8fv\\PycharmProjects\\Opencadd_real\\KLIFS Targets Output\\' + name)
        ws = out.active
